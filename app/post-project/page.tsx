...
const skillSuggestions: Record<string, string[]> = {
  "Web Development": ["HTML/CSS", "React", "Next.js", "JavaScript", "TypeScript", "Tailwind CSS", "Node.js", "WordPress", "PHP", "Responsive Design"],
  "Graphic Design": ["Adobe Photoshop", "Adobe Illustrator", "Canva", "Logo Design", "Branding", "Poster Design", "Social Media Graphics", "Print Design"],
  "Photography": ["Portrait", "Product", "Event", "Editing", "Lightroom", "Studio", "Outdoor", "Drone Photography"],
  "Video Editing": ["Adobe Premiere", "After Effects", "CapCut", "Motion Graphics", "Color Grading", "Short-Form Content", "Reels/TikTok", "Documentary"],
  "UI/UX Design": ["Figma", "Wireframing", "Prototyping", "User Research", "Design Systems", "Mobile Design", "Web Design", "Interaction Design"],
  "Content Writing": ["Blog Posts", "Copywriting", "SEO Writing", "Academic Writing", "Social Media Copy", "Scriptwriting", "Technical Writing", "Creative Writing"],
  "Social Media Management": ["Instagram", "Facebook", "TikTok", "Content Strategy", "Analytics", "Community Management", "Paid Ads", "Content Calendar"],
  Other: ["Research", "Data Entry", "Translation", "Tutoring", "Virtual Assistance"],
};
...
const urgencyLevels = [
  { value: "low", label: "Low", desc: "No rush, flexible deadline", color: "bg-[color:var(--tone-green-soft)] text-[color:var(--tone-green-deep)] border-[color:var(--tone-green-base)]/30" },
  { value: "medium", label: "Medium", desc: "Standard turnaround", color: "bg-[color:var(--tone-amber-soft)] text-[color:var(--tone-amber-deep)] border-[color:var(--tone-amber-base)]/30" },
  { value: "high", label: "High", desc: "Time-sensitive, need it soon", color: "bg-[color:var(--tone-orange-soft)] text-[color:var(--tone-orange-deep)] border-[color:var(--tone-orange-base)]/30" },
  { value: "urgent", label: "Urgent", desc: "Needed ASAP, willing to pay rush fee", color: "bg-[color:var(--tone-red-soft)] text-[color:var(--tone-red-deep)] border-[color:var(--tone-red-base)]/30" },
];
  ...
  return (
    ...
    >
      ...
      <section className="relative overflow-hidden px-5 pb-20 pt-32 sm:px-6 lg:px-8 lg:pb-24 lg:pt-40">
        {/* Gradient */}
        <div className="absolute inset-0 z-0 bg-gradient-to-br from-[color:var(--brand-orange)] via-[#FF8E53] to-[#FFA87E]" />
        ...
        <div className="absolute left-1/2 top-1/3 z-0 h-52 w-52 -translate-x-1/2 rounded-full bg-[#FFA87E]/30 blur-3xl" />
        {/* Grid */}
        <div
      ...
      <section className="relative px-5 pb-20 sm:px-6 lg:px-8">
        <div className="mx-auto -mt-14 max-w-[780px]">
          <div className="rounded-[2rem] border border-[color:var(--line-strong)] bg-white p-6 shadow-[0_24px_60px_rgba(108,99,255,0.10)] sm:p-10">
            {/* ─ Section header ─ */}
            <div className="mb-8 flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[color:var(--brand-orange)] to-[#FFA87E] text-white">
                <ClipboardIcon />
              </div>
              <div>
                ...
                <p className="text-xs text-[color:var(--ink-muted)]">
                  Fill in the details below and students will start sending proposals
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="space-y-2">
                <Label htmlFor="project-title" className="text-sm font-semibold text-foreground">
                  Project Title <span className="text-[color:var(--tone-red-base)]">*</span>
                </Label>
              ...
              <div className="space-y-2.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    type="text"
                    placeholder={selectedCategory ? "Type to add more skills…" : "Select a category first to see suggestions"}
                    value={skillInput}
                ...
                <p className="text-[11px] text-[color:var(--ink-soft)]">
                  Press <kbd className="rounded border border-[color:var(--line-strong)] bg-[color:var(--surface-alt)] px-1.5 py-0.5 text-[10px] font-semibold">Enter</kbd> to add a custom skill
                </p>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="project-description" className="text-sm font-semibold text-foreground">
                  Project Description <span className="text-[color:var(--tone-red-base)]">*</span>
                </Label>
                <Textarea
                ...
                />
                <p className="text-[11px] text-[color:var(--ink-soft)]">
                  Tip: include specifics like dimensions, formats, tone of voice, or color preferences.
                </p>
              </div>

              {/* ── 5. Expected Deliverables ── */}
              <div className="space-y-2">
                <Label htmlFor="deliverables" className="text-sm font-semibold text-foreground">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label className="text-sm font-semibold text-foreground">
                    Deadline / Timeline <span className="text-[color:var(--tone-red-base)]">*</span>
                  </Label>
                  <div className="relative">
                    <div className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-[color:var(--ink-muted)]">
                      <CalendarIcon />
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                  {urgencyLevels.map((u) => (
                    ...
                    >
                      ...
                      <span className="mt-0.5 text-[10px] leading-tight opacity-70">{u.desc}</span>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label className="text-sm font-semibold text-foreground">
                  Reference Files{" "}
                  <span className="font-normal text-[color:var(--ink-soft)]">(optional)</span>
                </Label>
                <label
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-[color:var(--ink-soft)]">
                      Mood boards, briefs, sample designs — PNG, JPG, PDF, DOCX up to 10 MB each
                    </p>
                  </div>
                  <input
                    id="project-files"
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <p className="max-w-xs text-xs leading-relaxed text-[color:var(--ink-soft)]">
                  ...
                  <a href="#" className="font-medium text-[color:var(--brand-orange)] hover:underline">Terms of Service</a>{" "}
                  and{" "}
                  <a href="#" className="font-medium text-[color:var(--brand-orange)] hover:underline">Community Guidelines</a>.
                </p>
                <Button
                  type="submit"
                  className="h-12 w-full rounded-xl bg-gradient-to-r from-[color:var(--brand-orange)] to-[#FFA87E] px-8 text-sm font-semibold text-white shadow-[0_8px_24px_rgba(108,99,255,0.35)] transition-all hover:shadow-[0_12px_32px_rgba(108,99,255,0.45)] hover:brightness-105 active:scale-[0.98] sm:w-auto"
                >
                  Post Project
                  <ArrowRightIcon />
                </Button>
      ...
      <section className="bg-[color:var(--surface-alt)] px-5 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="typo-section-title mb-3 text-foreground">
            How it{" "}
            <span className="bg-gradient-to-r from-[color:var(--brand-orange)] to-[#FFA87E] bg-clip-text text-transparent">works</span>
          </h2>
          <p className="typo-body mx-auto mb-12 max-w-lg text-[color:var(--ink-muted)]">
            From posting to delivery, we make commissioning student talent effortless.
          </p>

          <div className="grid gap-8 sm:grid-cols-3">
            {[
              { num: "01", emoji: "📝", title: "Post your project", desc: "Describe what you need, set your budget and timeline, and publish." },
              { num: "02", emoji: "💬", title: "Get proposals", desc: "Qualified BU students review your project and send tailored proposals." },
              { num: "03", emoji: "🤝", title: "Choose & collaborate", desc: "Pick your favorite, collaborate directly, and receive quality work." },
            ].map((step, i) => (
              <div key={step.num} className="group relative">
                ...
                <div className="flex flex-col items-center gap-4">
                  <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[color:var(--brand-orange)] to-[#FFA87E] text-2xl shadow-lg shadow-[color:var(--brand-orange)]/20 transition-transform group-hover:scale-110">
                    {step.emoji}
                  ...
                  <h3 className="typo-card-title-lg text-foreground">{step.title}</h3>
      ...
      <section className="px-5 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <h2 className="typo-section-title mb-3 text-center text-foreground">
            Why post on{" "}
            <span className="bg-gradient-to-r from-[color:var(--brand-orange)] to-[#FFA87E] bg-clip-text text-transparent">
              BRaket
            </span>
            ?
          </h2>
          <p className="typo-body-lg mx-auto mb-12 max-w-2xl text-center text-[color:var(--ink-muted)]">
            Access a growing pool of verified student talent ready to work on your projects.
          </p>

          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { icon: "🎓", title: "Verified BU Students", desc: "Every talent is a real Bicol University student with a reviewed portfolio.", gradient: "from-[color:var(--brand-orange)]/10 to-[#FFA87E]/10" },
              { icon: "💸", title: "Student-Friendly Rates", desc: "Quality work at rates that respect both your budget and the student's value.", gradient: "from-[color:var(--tone-green-soft)] to-[color:var(--tone-teal-soft)]" },
              { icon: "⚡", title: "Fast Turnaround", desc: "Motivated students eager to build their portfolios deliver results quickly.", gradient: "from-[color:var(--tone-amber-soft)] to-[color:var(--tone-orange-soft)]" },
              { icon: "🛡️", title: "Secure Commissions", desc: "Transparent milestones and handoff processes protect both parties.", gradient: "from-[color:var(--tone-sky-soft)] to-[color:var(--tone-indigo-soft)]" },
              { icon: "🤝", title: "Direct Collaboration", desc: "Work directly with talents — no middlemen, no hidden fees, just results.", gradient: "from-[color:var(--tone-pink-soft)] to-[color:var(--tone-purple-soft)]" },
              { icon: "🌟", title: "Community Impact", desc: "Support local student talent and help build the next generation of creators.", gradient: "from-[color:var(--tone-orange-soft)] to-[color:var(--tone-amber-soft)]" },
            ].map((card) => (
              <div
                key={card.title}
              ...
              >
                <div className={`mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${card.gradient} text-xl transition-transform group-hover:scale-110`}>
                  {card.icon}
                </div>
                <h3 className="typo-card-title-lg text-foreground">{card.title}</h3>
                <p className="mt-2 text-sm leading-relaxed text-[color:var(--ink-muted)]">{card.desc}</p>
              </div>
            ))}
          </div>
        </div>
